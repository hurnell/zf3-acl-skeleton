...
use Social\Providers\GitHubProvider as Provider;
 ...
 * 
 */
class GitHubProviderTest extends AbstractHttpControllerTestCase
{

//public static $shared_session = array(  ); 
    protected $providerName = 'git_hub';
    ...
    {
        $this->expectException(\Exception::class);
        $this->expectExceptionMessage('GitHub returned an error (1).');
        $mock = $this->builder->getSocialManagerClientMock();
        $this->builder->mockProviderClient($mock);
        $provider = new Provider($mock);
        $callback = $this->builder->getCallbackUrl($this->providerName);
    ...
    {
        $this->expectException(\Exception::class);
        $this->expectExceptionMessage('GitHub returned an error "response was not OK".');
        $mock = $this->builder->getSocialManagerClientMock();
        $this->builder->mockProviderClient($mock);
        $provider = new Provider($mock);
        $callback = $this->builder->getCallbackUrl($this->providerName);
    ...
    {
        $this->expectException(\Exception::class);
        $this->expectExceptionMessage('GitHub returned an error "no email".');
        $mock = $this->builder->getSocialManagerClientMock();
        $this->builder->mockProviderClient($mock);
        $provider = new Provider($mock);
        $callback = $this->builder->getCallbackUrl($this->providerName);
    ...
    {
        $this->expectException(\Exception::class);
        $this->expectExceptionMessage('GitHub returned an error "no name".');
        $mock = $this->builder->getSocialManagerClientMock();
        $this->builder->mockProviderClient($mock);
        $provider = new Provider($mock);
        $callback = $this->builder->getCallbackUrl($this->providerName);
    ...
    {
        $this->expectException(\Exception::class);
        $this->expectExceptionMessage('GitHub returned an error "no id".');
        $mock = $this->builder->getSocialManagerClientMock();
        $this->builder->mockProviderClient($mock);
        $provider = new Provider($mock);
        $callback = $this->builder->getCallbackUrl($this->providerName);
