...
use Social\Providers\LinkedInProvider as Provider;
 ...
 * 
 */
class LinkedInProviderTest extends AbstractHttpControllerTestCase
{

//public static $shared_session = array(  ); 
    protected $providerName = 'linked_in';
    ...
    {
        $this->expectException(\Exception::class);
        $this->expectExceptionMessage('LinkedIn returned an error (1).');
        $mock = $this->builder->getSocialManagerClientMock();
        $this->builder->mockProviderClient($mock);
        $provider = new Provider($mock);
        $callback = $this->builder->getCallbackUrl($this->providerName);
    ...
    {
        $this->expectException(\Exception::class);
        $this->expectExceptionMessage('LinkedIn returned an error "response was not OK".');
        $mock = $this->builder->getSocialManagerClientMock();
        $this->builder->mockProviderClient($mock);
        $provider = new Provider($mock);
        $callback = $this->builder->getCallbackUrl($this->providerName);
    ...
    {
        $this->expectException(\Exception::class);
        $this->expectExceptionMessage('LinkedIn returned an error "no email".');
        $mock = $this->builder->getSocialManagerClientMock();
        $this->builder->mockProviderClient($mock);
        $provider = new Provider($mock);
        $callback = $this->builder->getCallbackUrl($this->providerName);
    ...
    {
        $this->expectException(\Exception::class);
        $this->expectExceptionMessage('LinkedIn returned an error "no name".');
        $mock = $this->builder->getSocialManagerClientMock();
        $this->builder->mockProviderClient($mock);
        $provider = new Provider($mock);
        $callback = $this->builder->getCallbackUrl($this->providerName);
        ...
        $this->builder->setProviderJsonBody(1, '{"access_token":"access_token"}');
        $this->builder->setProviderStatusCode(3, 200);
        $this->builder->setProviderJsonBody(2, '{"emailAddress":"email"}');
        $provider->sendClientRequest($callback, $this->builder->getQueryParams());
    }
    ...
    {
        $this->expectException(\Exception::class);
        $this->expectExceptionMessage('LinkedIn returned an error "no id".');
        $mock = $this->builder->getSocialManagerClientMock();
        $this->builder->mockProviderClient($mock);
        $provider = new Provider($mock);
        $callback = $this->builder->getCallbackUrl($this->providerName);
        ...
        $this->builder->setProviderJsonBody(1, '{"access_token":"access_token"}');
        $this->builder->setProviderStatusCode(3, 200);
        $this->builder->setProviderJsonBody(2, '{"emailAddress":"email","formattedName":"name"}');
        $provider->sendClientRequest($callback, $this->builder->getQueryParams());
    }
    ...
    public function testProviderReturnUser()
    {
        ...
        $this->builder->setProviderJsonBody(1, '{"access_token":"access_token"}');
        $this->builder->setProviderStatusCode(3, 200);
        $this->builder->setProviderJsonBody(2, '{"emailAddress":"email","formattedName":"name","id":"id"}');
